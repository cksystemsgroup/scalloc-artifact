...
if [[ $# -ne 2 ]]; then
  echo "usage: scalloc-evaluate-frontend-cleanup-averaged.sh <allocator name> <preload>"
  echo ""
  echo "averaged a fixed configuration of the threadtest benchmark"
  echo ""
  echo "output directory: data/scalloc-frontend-evaluation/"
  echo "parameters:"
